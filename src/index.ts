...
//     const start = Date.now();
//     res.on('finish', () => {
//       logRequest(req.requestId, req.method, req.path, res.statusCode, Date.now() - start);
//     });
//     next();
//   });

//   /* =======================================================
//      🔥 1. PAYMENT CALLBACKS & WEBHOOKS (NO CORS / NO HELMET)
//      ======================================================= */
//   app.use(express.urlencoded({ extended: true })); // required for gateways
...
//   /* =======================================================
//      🔐 2. SECURITY MIDDLEWARE (APPLIES TO NORMAL API ONLY)
//      ======================================================= */
//   app.use(helmetMiddleware);
//   app.use(corsMiddleware);
//   app.use(rateLimiter);
...
//   // ⚠️ mount payments ONLY ONCE here
//   app.use('/api/v1/payments', paymentRoutes);
